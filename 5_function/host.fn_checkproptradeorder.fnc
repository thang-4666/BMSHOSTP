SET DEFINE OFF;
CREATE OR REPLACE FUNCTION fn_checkproptradeorder (f_language IN varchar2, f_acctno IN  varchar2, f_side IN  varchar2, f_symbol in varchar2,
...
-- End of DDL Script for Function HOSTBSCT6.DTOC

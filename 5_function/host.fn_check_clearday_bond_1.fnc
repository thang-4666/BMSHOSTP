SET DEFINE OFF;
CREATE OR REPLACE FUNCTION fn_check_clearday_bond_1( pv_sectype IN VARCHAR2, pv_clearday in varchar2)
--T10/2015 TTBT T+2:
--Ham check Chu ky thanh toan tren man hinh SYSTEM co = 1 hay k voi TH Trai phieu?

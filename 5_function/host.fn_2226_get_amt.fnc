SET DEFINE OFF;
CREATE OR REPLACE FUNCTION FN_2226_GET_AMT( pv_CAMASTID IN VARCHAR2,pv_TRADE IN NUMBER,pv_QTTYREGISTER IN NUMBER,pv_EXQTTYREGISTER IN NUMBER)
    RETURN NUMBER IS
    v_Result  NUMBER;
...
BEGIN
    ...
    l_dbl_amtexp:=0;
    l_dbl_qttyexp:=0;
    l_dblQTTYREGISTER:=pv_QTTYREGISTER+pv_EXQTTYREGISTER;

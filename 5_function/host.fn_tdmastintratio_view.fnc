SET DEFINE OFF;
CREATE OR REPLACE FUNCTION fn_tdmastintratio_VIEW(strACCTNO IN varchar2,
           ...
           Else  --Cac tai khoan khong bi Block
             ...
             if v_strSCHDTYPE='F' then
                ...
                Begin
                    ...
                    SELECT CASE WHEN v_strTERMCD = 'D' THEN v_dblTDTERM
                                WHEN v_strTERMCD = 'W' THEN v_dblTDTERM * 7
                                WHEN v_strTERMCD = 'W' THEN v_dblTDTERM * 30 END
                    INTO v_dblTDTERM_BK FROM DUAL;


                    SELECT INTRATE into v_dblTIERINTRATE FROM TDMSTSCHM
                    WHERE ACCTNO=strACCTNO AND FRAMT <= dblWITHDRAW AND TOAMT >dblWITHDRAW
                    AND FRTERM<= v_dblTDTERM_BK AND TOTERM> v_dblTDTERM_BK;

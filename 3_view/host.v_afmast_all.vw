...
(SHORTNAME, ACTYPE, ACNAME, CUSTID, FULLNAME, 
 ...
 MRTYPE, COUNTRY, EDITALLOW, APRALLOW, MRIRATIO, 
 MRMRATIO, MRLRATIO, PHONE1, ISDEBTT0)
BEQUEATH DEFINER
AS 
...
CASE WHEN CI.COREBANK='Y' THEN 'Yes' ELSE 'No' END COREBANKTEXT,
AF.ACCTNO ACCTNO, AF.AFTYPE,A10.CDCONTENT TYPENAME, A1.CDCONTENT TRADEFLOOR,
...
A0.cdcontent mrtype, A13.CDCONTENT COUNTRY, (CASE WHEN AF.STATUS IN ('B','C','N') THEN 'N' ELSE 'Y' END) EDITALLOW,
(CASE WHEN AF.STATUS IN ('P') THEN 'Y' ELSE 'N' END) APRALLOW,
AF.mriratio, AF.mrmratio, AF.mrlratio, CF.mobilesms PHONE1, AF.isdebtt0
FROM AFMAST AF,CFMAST CF,AFTYPE AFT,CIMAST CI, TLGROUPS GRP,MRTYPE MRT, ALLCODE A0,

SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_STRADE_SUBACCT_CI
(CUSTID, CUSTODYCD, ACCTNO, CASH_ON_HAND, OUTSTANDING, 
 AVAILCASH, PURCHASINGPOWER, AVAIL_ADVANCED_BAL, ADVANCED_BALANCE, PENDING_ADVANCED_BAL, 
 BALDEFOVD, ORG_CASH_RECEIVING_T0, ORG_CASH_RECEIVING_T1, ORG_CASH_RECEIVING_T2, ORG_CASH_RECEIVING_T3, 
 ORG_CASH_RECEIVING_TN, CASH_ADV_RECEIVING_T0, CASH_ADV_RECEIVING_T1, CASH_ADV_RECEIVING_T2, CASH_ADV_RECEIVING_T3, 
 CASH_ADV_RECEIVING_TN, CASH_RECEIVING_T0, CASH_RECEIVING_T1, CASH_RECEIVING_T2, CASH_RECEIVING_T3, 
 CASH_RECEIVING_TN, CASH_SENDING_T0, CASH_SENDING_T1, CASH_SENDING_T2, CASH_SENDING_T3, 
 CASH_SENDING_TN, AVAIL_ADVANCE_T1, AVAIL_ADVANCE_T2, AVAIL_ADVANCE_T3, CA_RECEVING_CASH_DIVIDEND, 
 LAST_CHANGE)
BEQUEATH DEFINER
AS 
SELECT CF.CUSTID, CF.CUSTODYCD,AF.ACCTNO, nvl(MST.BALANCE,0)-NVL(REFORDER.SECUREAMT,0) CASH_ON_HAND, nvl(MST.ODAMT,0) OUTSTANDING,
nvl(MST.BALANCE,0)-NVL(REFORDER.SECUREAMT,0)+nvl(adv.PPAVLADVANCE,0) - nvl(mst.odamt,0) - nvl(dfintdebtamt,0) - nvl(dfdebtamt,0) AVAILCASH,
nvl(MST.BALANCE,0)-NVL(REFORDER.SECUREAMT,0)+nvl(adv.PPAVLADVANCE,0) + nvl(af.advanceline,0) - nvl(mst.odamt,0) - nvl(dfintdebtamt,0) - nvl(dfdebtamt,0) PURCHASINGPOWER,
NVL(AVLADVANCE,0) AVLADVANCE, NVL(ADVANCED_BALANCE,0), 0 PENDING_ADVANCED_BAL,
greatest(nvl(adv.avladvance,0) + MST.balance- MST.odamt- MST.dfdebtamt - MST.dfintdebtamt - NVL (REFORDER.advamt, 0)-nvl(REFORDER.secureamt,0) - MST.ramt-nvl(pd.dealpaidamt,0),0) baldefovd,
NVL(ORG_CASH_RECEIVING_T0,0) ORG_CASH_RECEIVING_T0,NVL(ORG_CASH_RECEIVING_T1,0) ORG_CASH_RECEIVING_T1, NVL(ORG_CASH_RECEIVING_T2,0) ORG_CASH_RECEIVING_T2, NVL(ORG_CASH_RECEIVING_T3,0) ORG_CASH_RECEIVING_T3,NVL(ORG_CASH_RECEIVING_TN,0) ORG_CASH_RECEIVING_TN,
NVL(CASH_ADV_RECEIVING_T0,0) CASH_ADV_RECEIVING_T0,NVL(CASH_ADV_RECEIVING_T1,0) CASH_ADV_RECEIVING_T1, NVL(CASH_ADV_RECEIVING_T2,0) CASH_ADV_RECEIVING_T2, NVL(CASH_ADV_RECEIVING_T3,0) CASH_ADV_RECEIVING_T3,NVL(CASH_ADV_RECEIVING_TN,0) CASH_ADV_RECEIVING_TN,
NVL(CASH_RECEIVING_T0,0) CASH_RECEIVING_T0,NVL(CASH_RECEIVING_T1,0) CASH_RECEIVING_T1, NVL(CASH_RECEIVING_T2,0) CASH_RECEIVING_T2, NVL(CASH_RECEIVING_T3,0) CASH_RECEIVING_T3,NVL(CASH_RECEIVING_TN,0) CASH_RECEIVING_TN,
NVL(CASH_SENDING_T0,0) CASH_SENDING_T0, NVL(CASH_SENDING_T1,0) CASH_SENDING_T1, NVL(CASH_SENDING_T2,0) CASH_SENDING_T2, NVL(CASH_SENDING_T3,0) CASH_SENDING_T3,
NVL(CASH_SENDING_TN,0) CASH_SENDING_TN,NVL(AVAIL_ADVANCE_T1,0) AVAIL_ADVANCE_T1, NVL(AVAIL_ADVANCE_T2,0) AVAIL_ADVANCE_T2, NVL(AVAIL_ADVANCE_T3,0) AVAIL_ADVANCE_T3, nvl(carcv.amt,0) CA_RECEVING_CASH_DIVIDEND,
MST.last_change last_change

...
(AUTOID, CAMASTID, CUSTODYCD, AFACCTNO, CODEID, 
 ...
 VSDCAID, REPORTDATE, PQTTY, TRADE, MAXQTTY, 
 A, B, QTTY, BEGINDATE, DUEDATE, 
 ACCTNO, FULLNAME, IDCODE, ISINCODE, ISFULLNAME, 
 COUNTRY, TRADINGCODE, QUOCGIA, BALANCE)
BEQUEATH DEFINER
AS 
(
SELECT schd.autoid,ca.camastid,cf.custodycd,af.acctno afacctno,sec1.codeid,sec2.codeid tocodeid,
sec1.symbol,sec2.symbol tosymbol,cf.iddate,cf.idplace, ca.vsdcaid,

SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_GETSECMARGINDETAIL
(CUSTODYCD, AFACCTNO, ACCTNO, CODEID, SYMBOL, 
 TRADE, RECEIVING, EXECQTTY, BUYQTTY, BUYINGQTTY, 
 MORTAGE, EMKQTTY, RATECL, PRICECL, CALLRATECL, 
 CALLPRICECL, CALLRATE74, CALLPRICE74, SEAMT, SEASS, 
 SEREAL, MRMAXQTTY, SEQTTY, BASICPRICE, COSTPRICE, 
 CARECEIVING, BLOCKED)
BEQUEATH DEFINER
AS 
select cf.custodycd, af.acctno afacctno, se.acctno, se.codeid, sb.symbol,
    trade, receiving, execqtty, buyqtty,buyingqtty, mortage, emkqtty,
   ...
   nvl(sb.BASICPRICE,0) BASICPRICE, se.COSTPRICE,se.careceiving,se.BLOCKED
                from
                (select se.codeid, af.actype, af.mriratio, se.afacctno,se.acctno, se.trade, se.mortage, SE.emkqtty ,se.COSTPRICE,se.BLOCKED,
                ...
                and trade + receiving - execqtty + buyqtty + mortage + emkqtty> 0
/

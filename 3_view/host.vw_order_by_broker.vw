SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_ORDER_BY_BROKER
...
FROM  FOMAST E, TLPROFILES F, BRGRP BR
WHERE E.USERNAME = F.TLID(+) AND LENGTH(ORGACCTNO) = 16 AND E.STATUS ='A' AND F.BRID=BR.BRID
UNION
...
FROM TLLOG A, ODMAST B, TLPROFILES D, BRGRP BRF

SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW V_CA3302
(AUTOID, BALANCE, RQTTY, PBALANCE, AFACCTNO, 
 ...
 SENDPBALANCE, SENDAMT, SENDRQTTY, ISINCODE)
BEQUEATH DEFINER
AS 
SELECT
...
CA.QTTY, CA.AMT, CA.AQTTY,CA.NMQTTY,(CASE WHEN camast.catype='014' THEN  (CA.qtty+ca.cutqtty+ca.sendqtty  - CA.NMQTTY-CA.INQTTY)ELSE 0 END) MQTTY,

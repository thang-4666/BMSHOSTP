...
select od.afacctno,
      ...
      from afmast af, aftype aft, --odmast od,
       (select orderid,afacctno,exectype,txdate,od.remainqtty,od.quoteprice,od.bratio,
               od.matchamt - od.CFNETEXECAMT - od.NETEXECAMT matchamt, od.feeacr- od.feeamt feeacr
       from odmast od)  od, --HSX04
      mrtype mrt,

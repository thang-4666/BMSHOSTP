SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW AQ$TXAQS_FLEX2VSD_TABLE
(QUEUE, MSG_ID, CORR_ID, MSG_PRIORITY, MSG_STATE, 
 DELAY, DELAY_TIMESTAMP, EXPIRATION, ENQ_TIME, ENQ_TIMESTAMP, 
 ENQ_USER_ID, ENQ_TXN_ID, DEQ_TIME, DEQ_TIMESTAMP, DEQ_USER_ID, 
 DEQ_TXN_ID, RETRY_COUNT, EXCEPTION_QUEUE_OWNER, EXCEPTION_QUEUE, USER_DATA, 
 ORIGINAL_QUEUE_NAME, ORIGINAL_QUEUE_OWNER, EXPIRATION_REASON, SENDER_NAME, SENDER_ADDRESS, 
 SENDER_PROTOCOL, ORIGINAL_MSGID)
BEQUEATH DEFINER
AS 
                     ...
                     decode(deq_time, NULL, 
                       ...
                       decode (expiration , NULL , 'MAX_RETRY_EXCEEDED',
                            'TIME_EXPIRATION'),
                             ...
                             EXPIRATION_REASON , sender_name SENDER_NAME, sender_address SENDER_ADDRESS, sender_protocol SENDER_PROTOCOL, dequeue_msgid ORIGINAL_MSGID  FROM "TXAQS_FLEX2VSD_TABLE" WHERE state != 7 AND   state != 9 WITH READ ONLY
/

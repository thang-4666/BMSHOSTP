...
BEQUEATH DEFINER
AS 
(SELECT CA.AUTOID,CA.ISCI,CA.ISCISE,(case when CF.STATUS IN ('P','A') Then 'Hoạt động' else 'Đóng' end ) CFSTATUS,CA.BALANCE, SUBSTR(CA.CAMASTID,1,4) || '.' || SUBSTR(CA.CAMASTID,5,6) || '.' || SUBSTR(CA.CAMASTID,11,6) CAMASTID,
       ...
       to_char('Đổi phương thức thu thuế, '||CAMAST.description) DESCRIPTION,cf.custodycd,cf.fullname,cf.idcode, a2.cdcontent CAVAT, CA.PITRATEMETHOD VAT,a3.cdcontent CAVAT2,
       (CASE WHEN cf.VAT='Y' THEN --T9/2019 CW_PhaseII
                                  (CASE
...
WHERE A0.CDTYPE = 'CA' AND A0.CDNAME = 'CATYPE' AND A0.CDVAL = CAMAST.CATYPE
      ...
      And CAMAST.CATYPE in ('010','011','021','015','016','009','017','020','023','028')

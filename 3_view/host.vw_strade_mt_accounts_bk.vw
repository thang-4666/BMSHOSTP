SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_STRADE_MT_ACCOUNTS_BK
...
select MST.Cityef, MST.Citybank, afm.acctno AFACCTNO, MST.TYPE,
    ...
    cf.custodycd, var1.VARVALUE MTFRTIME, var2.VARVALUE MTTOTIME, /*af.TYPEMNEMONIC*/ null TYPEMNEMONIC
FROM CFOTHERACC MST,
...
select null cityef, NULL  citybank, AF2.acctno afacctno, '0' type, 'Noi bo' reg_type, 'Internal' en_reg_type,
    ...
    Cf.custodycd custodycd, var1.VARVALUE MTFRTIME, var2.VARVALUE MTTOTIME, a1.cdcontent TYPEMNEMONIC

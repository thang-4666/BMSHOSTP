SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_OL_ACCOUNT_SE
(ACCTNO, CUSTID, AFACCTNO, CUSTODYCD, SYMBOL, 
 COSTPRICE, TRADE_QTTY, BLOCKED, SECURITIES_RECEIVING, CPQUYENVE, 
 CPTHUONG, COTUCTIEN, DEALFINANCING_QTTY, SECURITIES_RECEIVING_T0, SECURITIES_RECEIVING_T1, 
 SECURITIES_RECEIVING_T2, SECURITIES_RECEIVING_T3, SECURITIES_RECEIVING_TN, SECURITIES_SENDING_T0, SECURITIES_SENDING_T1, 
 SECURITIES_SENDING_T2, SECURITIES_SENDING_T3, SECURITIES_SENDING_TN)
BEQUEATH DEFINER
AS 
SELECT MST.ACCTNO, CF.CUSTID,AF.acctno AFACCTNO, CF.CUSTODYCD, SB.SYMBOL, COSTPRICE,
MST.TRADE - NVL(SECURED.SECUREAMT,0) /*+ NVL(DFMAST.DFQTTY,0)*/ TRADE_QTTY,
MST.BLOCKED BLOCKED,

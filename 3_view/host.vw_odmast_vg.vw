SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_ODMAST_VG
...
vw."EDSTATUS",vw."ACTYPE",vw."VIA",vw."MAKER",vw."MAKETIME",vw."SENDTIME",vw."TIMETYPE",
...
SELECT od.orderid orderid, od.reforderid, a0.cdcontent tradeplace,
        ...
        ot.typename actype, a2.cdcontent via, mk.tlid maker,
        od.txtime maketime,

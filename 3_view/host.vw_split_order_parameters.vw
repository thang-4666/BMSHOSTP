...
SUM(CASE WHEN VARNAME='HOSE_MAX_QUANTITY' THEN TO_NUMBER(VARVALUE) ELSE 0 END) MAX_QTTY,
...
FROM SYSVAR
WHERE VARNAME IN ('HSX_MINBREAKSIZE_QTTY','HOSE_MAX_QUANTITY','HSX_MINBREAKSIZE_CNT','HSX_MAXBREAKSIZE_CNT','HSX_START_QTTY')
UNION ALL
...
SUM(CASE WHEN VARNAME='HNX_MAX_QUANTITY' THEN TO_NUMBER(VARVALUE) ELSE 0 END) MAX_QTTY,
...
FROM SYSVAR
WHERE VARNAME IN ('HNX_MINBREAKSIZE_QTTY','HNX_MAX_QUANTITY','HNX_MINBREAKSIZE_CNT','HNX_MAXBREAKSIZE_CNT','HNX_START_QTTY')
UNION ALL

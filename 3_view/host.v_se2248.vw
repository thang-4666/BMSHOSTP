...
(ACCTNO, SYMBOL, TXNUM, AFACCTNO, DTOCLOSE, 
 ...
 BLOCKDTOCLOSE, SEQTTY, TOCUSTODYCD, TOAFACCTNO, TOFULLNAME)
BEQUEATH DEFINER
AS 
(
SELECT   SUBSTR(SEMAST.ACCTNO,1,4) || '.' || SUBSTR(SEMAST.ACCTNO,5,6) || '.' || SUBSTR(SEMAST.ACCTNO,11,6) ACCTNO, SYM.SYMBOL, trf.TXNUM,

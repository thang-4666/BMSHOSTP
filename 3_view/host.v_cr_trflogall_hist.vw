SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW V_CR_TRFLOGALL_HIST
...
FROM vw_CRBTRFLOG_all MST, ALLCODE A0, ALLCODE A1,DEFERROR ERR,CRBDEFACCT CRA,ALLCODE A2,
(
    ...
    FROM vw_CRBTRFLOGDTL_all DTL,vw_CRBTXREQ_all REQ

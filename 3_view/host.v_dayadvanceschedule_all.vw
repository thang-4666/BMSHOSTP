SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW V_DAYADVANCESCHEDULE_ALL
(AFACCTNO, AMT, FULLNAME, CUSTODYCD, COREBANK, 
 ...
 ADNAME, SRCTYPE, SRCNAME, CIACCTNO, CUSTBANK, 
...
SELECT MST.AFACCTNO,MST.AMT,MST.FULLNAME,MST.CUSTODYCD,
                ...
                avatrate VAT, ADVAMT, RIGHTVAT, MST.ADTYPE, MST.ADNAME, MST.SRCTYPE, MST.SRCNAME, MST.ciacctno, MST.custbank, MST.REMAINPOOL,
                CIDRAWNDOWN, BANKDRAWNDOWN, CMPDRAWNDOWN,
                (CASE WHEN BANKDRAWNDOWN=1 THEN 0 ELSE 1 END) AUTODRAWNDOWN,
                MST.AFACCTNO || MST.ADTYPE || to_char(MST.TXDATE,'DDMMYYYY') || to_char(MST.CLEARDATE,'DDMMYYYY') FILTERID,autoadv
        ...
        FROM (
                SELECT  STS.AFACCTNO,STS.AMT,CF.FULLNAME,CF.CUSTODYCD,CASE WHEN CI.COREBANK='Y' THEN 0 ELSE 1 END COREBANK,
                    ...
                    STS.CLEARDATE,STS.DAYS, STS.TXDATE, STS.ADTYPENAME ADNAME,
                    ROUND(LEAST(
                    ...
                    STS.ADTYPE, STS.ADTYPENAME, STS.RRTYPE SRCTYPE, A1.CDCONTENT SRCNAME, sts.ciacctno, sts.custbank, sts.avatrate,sts.autoadv,

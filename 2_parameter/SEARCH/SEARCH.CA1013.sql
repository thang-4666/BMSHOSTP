SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1013','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CA1013', 'Danh sách chi trả lợi tức chứng quyền (đối chiếu)', 'Summary list of Payout of the warrant certificate (comparison)', 'SELECT * FROM (SELECT CF.CUSTODYCD,MAX(CAS.AUTOID) AUTOID,CAS.CAMASTID,
...
AND CA.CATYPE = ''028''
AND AF.CUSTID = CF.CUSTID  GROUP BY ca.isincode,CF.CUSTODYCD,CAS.CAMASTID,CF.FULLNAME,CF.IDCODE,CF.IDDATE) WHERE 0=0', 'CASCHD', 'frmCASCHD', '', '', NULL, 50, 'N', 30, 'NYNNYYYNNY', 'Y', 'T', '', 'N', '', '');COMMIT;
SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2241','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('SE2241', 'Tra cứu các tài khoản đang chờ gửi hồ sơ lưu ký(2241)', 'View pending to send depository center (wait for 2241)', 'SELECT  SEDEPOSIT.DEPODATE TXDATE,A4.CDCONTENT TRADEPLACE ,SEMAST.ACTYPE,
...
AND SEDEPOSIT.ACCTNO=SEMAST.ACCTNO', 'SEMAST', '', '', '2241', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
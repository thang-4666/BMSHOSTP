SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RE0321','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RE0321', 'Tra cứu tính hoa hồng (Giao dịch 0321 để chốt hoa hồng)', 'View calculating commission for remiser (wait for 0321)', 'SELECT MST.ACCTNO,
MST.CUSTID RECUSTID, TYP.TYPENAME, CF.FULLNAME, RF.AFACCTNO,MST.CUSTID,
...
AND (<$BRID> =''0001'' or RF.BRID = <$BRID>)', 'RE.REMAST', 'frmREMAST', '', '0321', 0, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
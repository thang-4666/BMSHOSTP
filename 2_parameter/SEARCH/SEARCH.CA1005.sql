SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1005','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CA1005', 'Chia cổ tức băng cổ phiếu (đối chiếu)', 'Chia cổ tức băng cổ phiếu (đối chiếu)', 'SELECT * FROM (SELECT CF.CUSTODYCD,MAX(CAS.AUTOID) AUTOID,CAS.CAMASTID, MAX(CAS.AFACCTNO) AFACCTNO,
...
AND CAS.CAMASTID = CA.CAMASTID AND CA.CODEID = SYM.CODEID AND CA.CATYPE IN (''011'')

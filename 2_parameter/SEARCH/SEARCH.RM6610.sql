SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RM6610','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RM6610', 'Tra cứu các giao dịch phong toả bị lệch (6610)', 'View unmatched holdid (6610)', 'SELECT CH.REFNO,CH.BANKCODE,CRB.BANKNAME,CF.CUSTODYCD,CF.FULLNAME,AF.ACCTNO AFACCTNO,
...
AND (CH.HOLDAMOUNT<>CH.BANKAMOUNT OR CG.TOTALCHOLD<>CG.TOTALBHOLD)', 'BANKINFO', '', '', '6610', 0, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
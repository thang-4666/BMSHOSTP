SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('PODETAILS_RP','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('PODETAILS_RP', 'Thực cắt tiền đăng ký quyền mua', 'Thực cắt tiền đăng ký quyền mua', 'SELECT PO.POTXNUM, PO.POTXDATE, CM.REPORTDATE, CA.CAMASTID, SB.SYMBOL, CF.CUSTODYCD, AF.ACCTNO, CF.FULLNAME,

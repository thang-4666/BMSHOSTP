SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CI1103','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CI1103', 'Tra cứu lệnh cho phép trả ứng trước (1103)', 'View available order for paid advance payment (wait for 1103)', 'SELECT * FROM (SELECT (CASE WHEN ODMAST.exectype=''MS'' THEN 1 ELSE 0 END) ISMORTAGE,CD.CDCONTENT MORTAGE,

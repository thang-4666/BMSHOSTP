...
FROM SEMAST SE,AFMAST AF,CFMAST CF,SECURITIES_INFO SB,
 ...
 AND se.TRADE + SE.RECEIVING+NVL(B.MATCHEDAMT,0) +NVL(B.REMAINQTTY,0)>0', 'CFMAST', '', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
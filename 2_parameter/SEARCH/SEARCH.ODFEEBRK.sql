SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('ODFEEBRK','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('ODFEEBRK', 'Quản lý tiểu khoản', 'Contract management', 'Select a.*, nvl(LIMITMAX,0)LIMITMAX ,nvl(USERHAVE,0)USERHAVE from
...
A2.CDCONTENT TRADETELEPHONE,A3.CDCONTENT TRADEONLINE,cf.PIN,cf.MOBILESMS TRADEPHONE9,CF.IDCODE,CF.IDDATE, CF.IDPLACE,  AF.TLID OLDTLID,
AF.BANKACCTNO,AF.SWIFTCODE,cf.EMAIL,cf.ADDRESS,cf.FAX, A11.CDCONTENT ISOTC, A12.CDCONTENT VIA,
format_subac(AF.ACCTNO) CIACCTNO,AF.LASTDATE,A8.CDCONTENT STATUS,  AF.TLID,
...
''N'' AS DELALLOW, CF.OPNDATE, BR.brname
FROM AFMAST AF,CFMAST CF,AFTYPE AFT, TLGROUPS GRP,MRTYPE MRT,BRGRP BR, ALLCODE A0,
...
WHERE AF.CUSTID=CF.CUSTID AND AF.ACTYPE=AFT.ACTYPE AND AFT.MRTYPE=MRT.ACTYPE AND CF.BRID= BR.BRID
...
(Select NVL(US.ACCTLIMIT,0) LIMITMAX,NVL(US.ALLOCATELIMMIT-US.USEDLIMMIT,0) USERHAVE
  from userlimit US where US.tliduser=''<$TELLERID>'') us on 0=0', 'AFMAST', 'frmAFMAST', '', 'EXEC', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
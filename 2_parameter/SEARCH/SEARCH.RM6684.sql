SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RM6684','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RM6684', 'Tra cứu danh sách bảng kê bị lỗi chờ gửi lại (6684)', 'View error EOD report waiting for resend (6684)', 'SELECT MST.AUTOID, MST.VERSION,MST.VERSIONLOCAL, MST.TXDATE, MST.REFBANK,MST.REFBANK || '':'' || CRB.BANKNAME BANKNAME
...
AND A1.CDVAL=MST.TRFCODE AND MST.STATUS IN (''E'',''H'') AND MST.ERRSTS=''N''', 'CRBTRFLOG', '', '', '6684', 0, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
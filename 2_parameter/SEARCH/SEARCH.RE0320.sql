SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RE0320','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RE0320', 'Tra cứu tính hoa hồng (Giao dịch 0320 để chốt hoa hồng)', 'View calculating commission for remiser (wait for 0320)', 'SELECT MST.ACCTNO, MST.CUSTID RECUSTID, TYP.TYPENAME, CF.FULLNAME, TYP.RATEFEE, TYP.RATECOMM,
...
AND RF.CUSTID=MST.CUSTID AND FN_RE_GETCOMMISION(MST.ACCTNO)>0', 'RE.REMAST', 'frmREMAST', '', '0320', 0, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
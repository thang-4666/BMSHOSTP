SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RECF_NOTDG','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RECF_NOTDG', 'Loại hình môi giới/Không là Chăm sóc hộ', 'Remiser/Not DG', 'SELECT (CF.CUSTID||''.''||RF.REACTYPE) REACCT, RF.AUTOID, CFMAST.FULLNAME, TYP.ACTYPE, TYP.TYPENAME, A2.CDCONTENT AFSTATUS, 
            ...
            FROM RECFDEF RF, RETYPE TYP, ALLCODE A0, ALLCODE A1, ALLCODE A2, RECFLNK CF, CFMAST
              WHERE A0.CDTYPE=''RE'' AND A0.CDNAME=''REROLE'' AND A0.CDVAL=TYP.REROLE
                    ...
                    AND CF.CUSTID = CFMAST.CUSTID AND TYP.REROLE <> ''DG''', 'RE.RECF_NOTDG', 'frmRECF_NOTDG', 'ACTYPE,TYPENAME,FULLNAME', '', 0, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
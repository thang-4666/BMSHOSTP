SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2299','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('SE2299', 'Tra cứu danh sách bảng kê chờ huỷ (2299)', 'View EOD report waiting for cancel (2299)', 'SELECT MST.AUTOID, MST.VERSION,MST.VERSIONLOCAL, MST.TXDATE, MST.REFBANK,NVL(CRB.BANKNAME,MST.REFBANK) BANKNAME
...
AND A1.CDVAL=MST.TRFCODE AND MST.STATUS IN (''A'')', 'CRBTRFLOG', '', '', '2299', 0, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
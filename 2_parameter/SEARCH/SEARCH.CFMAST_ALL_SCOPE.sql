SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CFMAST_ALL_SCOPE','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CFMAST_ALL_SCOPE', 'Thông tin khách hàng', 'Customer information', 'SELECT format_custid(CF.CUSTID) CUSTID,
CF.CUSTODYCD,
...
(CASE WHEN CF.STATUS IN (''P'') THEN ''Y'' ELSE ''N'' END) APRALLOW, ''Y'' DELALLOW, CF.RISKLEVEL, CF.ACTIVESTS, CF.CUSTTYPE, CF.ACTYPE
FROM
...
AND CF.CUSTID IN (SELECT CUSTID FROM
...
AND (CASE WHEN D.CHKSCOPE=''R'' THEN IDXREGION ELSE 1 END)>0 )', 'CFMAST_ALL', 'frmCFMAST', '', '', NULL, 50, 'N', 30, '', 'N', 'T', '', 'N', '', '');COMMIT;
SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1002','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CA1002', 'Lấy ý kiến cổ đông, đại hội cổ đông, quyền bỏ phiếu (đối chiếu)', 'Lấy ý kiến cổ đông, đại hội cổ đông, quyền bỏ phiếu (đối chiếu)', 'SELECT * FROM (SELECT CF.CUSTODYCD,MAX(CAS.AUTOID) AUTOID,CAS.CAMASTID,
...
AND CAS.CAMASTID = CA.CAMASTID AND CA.CODEID = SYM.CODEID AND CA.CATYPE IN (''005'',''006'',''022'')
AND CAS.DELTD =''N'' AND CA.DELTD=''N'' AND CAS.AFACCTNO= AF.ACCTNO
AND AF.CUSTID = CF.CUSTID  GROUP BY CF.CUSTODYCD,CAS.CAMASTID,CF.FULLNAME,CF.IDCODE,CF.IDDATE, ca.isincode) WHERE 0=0', 'CASCHD', 'frmCASCHD', '', '', NULL, 50, 'N', 30, 'NYNNYYYNNY', 'Y', 'T', '', 'N', '', 'CUSTODYCD');COMMIT;
...
FROM CFAFTRDLNK MST, TLPROFILES TL, TLGROUPS GRP, TLPROFILES AD, TLPROFILES LD, ALLCODE A0,
  (SELECT A.AUTOID, B.MAKER_ID, B.MAKER_DT, B.APPROVE_ID, B.APPROVE_DT, MK.TLNAME MKNAME, CK.TLNAME CKNAME
  FROM
  ...
  AND A0.CDTYPE=''SY'' AND A0.CDNAME=''TYPESTS'' AND A0.CDVAL=MST.STATUS', 'CFAFTRDLNK', 'frmCFAFTRDLNK', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('PODETAILS','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('PODETAILS', 'Thực cắt tiền đăng ký quyền mua', 'Thực cắt tiền đăng ký quyền mua', 'SELECT PO.POTXNUM, PO.POTXDATE, CM.REPORTDATE, CA.CAMASTID, SB.SYMBOL, CITR.TXNUM, CITR.TXDATE, CF.CUSTODYCD, AF.ACCTNO, CF.FULLNAME,
   ...
   WHERE CF.CUSTID = AF.CUSTID AND AF.ACCTNO = CA.AFACCTNO
         ...
         AND CITR.ACCTNO = AF.ACCTNO', 'PODETAILS', '', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
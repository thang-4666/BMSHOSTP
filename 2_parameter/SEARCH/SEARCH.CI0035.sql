SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CI0035','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CI0035', 'Danh sách bảng kê ứng trước', 'View advance payment', 'SELECT AD.AUTOID, AD.TXNUM, AD.TXDATE, AD.ACCTNO, AD.AMT, AD.FEEAMT, AD.DELTD,
...
/*AND AD.TXDATE=TO_DATE(''<$BUSDATE>'',''DD/MM/RRRR'')*/ ', 'CIMAST', '', '', '0035', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
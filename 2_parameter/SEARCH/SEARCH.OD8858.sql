SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('OD8858','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('OD8858', 'Tra cứu giải tỏa lệnh mua ATO (8858)', 'Refuse ATO buy order(wait for 8858)', 'SELECT MST.ORDERID,OOD.ORGORDERID,OOD.OODSTATUS ,MST.ACTYPE, MST.CODEID, CCY.SYMBOL, CCY.PARVALUE, MST.AFACCTNO, MST.SEACCTNO, MST.CIACCTNO,
...
FROM ODMAST MST,OOD, TLLOG TLG,AFMAST AF,CFMAST CF, SBSECURITIES CCY, CIMAST CI,SEMAST SE,ALLCODE A0,ALLCODE A1
...
AND MST.PRICETYPE IN (''ATO'', ''ATC'', ''MP'', ''MO'') AND MST.ORSTATUS=''8'' AND
(CASE WHEN (TLG.OFFID IS NULL) AND TLG.TLTXCD NOT IN (''8876'', ''8877'', ''8882'', ''8883'', ''8884'', ''8885'')
THEN ''1'' ELSE ''0'' END ) =''0'' AND A0.CDNAME=''ORSTATUS''
AND A0.CDVAL=MST.ORSTATUS AND A1.CDTYPE=''OD'' AND A1.CDNAME=''PRICETYPE'' AND A1.CDVAL=MST.PRICETYPE AND OOD.OODSTATUS=''N''', 'ODMAST', '', '', '8858', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
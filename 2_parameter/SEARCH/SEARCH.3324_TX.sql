SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('3324_TX','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('3324_TX', 'Danh sách GD 3324', 'List of 3324 trans', 'SELECT TL.AUTOID, TL.TXNUM||TO_CHAR(TL.TXDATE,''RRRRMMDD'') TXCODE, TL.TXDATE, TL.TXNUM, TL.TXDESC, SB.SYMBOL, CF.CUSTODYCD, TF.RECAFACCTNO AFACCTNO, QTTY, PRICE, QTTY*PRICE AMT
...
AND CF.CUSTTYPE = ''B''', '3324TX', '', 'autoid', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
...
ELSE OD.ORSTATUS END) = A1.CDVAL and (CF.CAREBY IN (SELECT TLGRP.GRPID FROM TLGRPUSERS TLGRP WHERE TLID = ''<$TELLERID>'') OR ''0001''=''<$TELLERID>'')', 'ODMAST', 'frmODMAST', 'ORDERID DESC', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
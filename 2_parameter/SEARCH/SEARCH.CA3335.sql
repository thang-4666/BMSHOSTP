SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA3335','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CA3335', 'Tra cứu xác nhận danh sách người sở hữu chứng khoán lưu ký thực hiện quyền', 'Tra cứu xác nhận danh sách người sở hữu chứng khoán lưu ký thực hiện quyền', 'SELECT CA.CAMASTID, A1.<@CDCONTENT> CATYPE,CA.CODEID,SB.SYMBOL,A2.<@CDCONTENT> CASTATUS, CA.REPORTDATE, CA.DESCRIPTION,
...
AND MT564.VSDPROMSG_VALUE = ''NEWM''', 'CAMAST', '', 'CAMASTID DESC', '3335', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SA0094','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('SA0094', 'Điều chỉnh ICCF (0094)', 'Adjust ICCF (Wait for 0094)', 'SELECT ICCF.AUTOID, TYP.TYPENAME, ICCF.EVENTNAME, ICCF.MODCODE, ICCF.ACTYPE, ICCF.EVENTCODE, ICCF.DESC_RULETYPE,
...
FROM ((SELECT ''CI'' MODCODE, ACTYPE, TYPENAME FROM CITYPE TYP
      ...
      UNION ALL SELECT ''OD'' MODCODE, ACTYPE, TYPENAME FROM ODTYPE TYP) TYP JOIN
                ...
                ON TYP.MODCODE=ICCF.MODCODE AND TYP.ACTYPE=ICCF.ACTYPE) WHERE 0=0 ', 'ICCFTYPEDEF', '', '', '0094', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
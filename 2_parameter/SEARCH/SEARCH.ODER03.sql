...
SELECT OD.TXDATE, OD.ORDERID, CF.CUSTODYCD, STS.AFACCTNO, STS.ACCTNO CIACCTNO, AD.RRTYPE, AD.CUSTBANK, AD.AUTOID STAUTOID,
    ...
    ADL.AAMT, 
    --GREATEST(ROUND(ADL.AAMT * ADT.ADVRATE/36000 * (AD.CLEARDT - AD.TXDATE)), ADT.ADVMINFEE) FEEAMT,  
    AD.FEEAMT,
...
WHERE 0 = 0', 'ODMAST', '', 'TXDATE DESC, CUSTODYCD, SYMBOL, ORDERID', '8842', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', 'CUSTODYCD');COMMIT;
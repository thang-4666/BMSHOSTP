SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CASCHD','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CASCHD', 'Thông tin CK được thực hiện quyền', 'Coporate action detail', 'SELECT CA.AUTOID, CA.BALANCE, CA.CAMASTID, CA.AFACCTNO,A0.CDCONTENT CATYPE, CA.CODEID, CA.EXCODEID, CA.QTTY, CA.AMT, CA.AQTTY,
       ...
       CA.ISCI,ISSE,CA.PBALANCE, CA.RQTTY, CA.TRADE,CAMAST.DESCRIPTION,afmast.BANKNAME,afmast.BANKACCTNO, camast.isincode
...
and nvl(camast.tocodeid,camast.codeid)=symto.codeid', 'CASCHD', 'frmCASCHD', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
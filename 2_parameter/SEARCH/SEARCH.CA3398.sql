SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA3398','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CA3398', 'DS KH chờ nhận chuyển nhượng quyền mua(GD 3398)', 'Transfer (3398)', 'SELECT TO_CHAR(MST.TXDATE,''DDMMRRRR'') || MST.TXNUM TXKEY, MST.CAMASTID, CAMAST.OPTCODEID, CAMAST.CODEID,
...
WHERE MST.STATUSRE = ''N'' AND  SUBSTR(MST.TOACCTNO,1,3) = ''086''
    ...
    AND A2.CDTYPE = ''CF'' AND A2.CDNAME = ''COUNTRY'' AND CF2.COUNTRY = A2.CDVAL(+)', 'CAMAST', '', '', '3398', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', 'CUSTODYCD');COMMIT;
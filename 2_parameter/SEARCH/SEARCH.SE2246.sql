SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2246','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('SE2246', 'Tra cứu các tài khoản đang chờ duyệt từ trung tâm lưu ký (2246)', 'View pending to approve from depository center (wait for 2246)', '
...
A4.CDCONTENT TRADEPLACE, SEMAST.ACTYPE,
                ...
                CI.DEPOLASTDT,SEDEPOSIT.VSDCODE
 ...
 WHERE SEMAST.SENDDEPOSIT > 0
   ...
   ', 'SEMAST', '', 'TXDATE', '2246', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RPTYPE','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RPTYPE', 'Quản lý tài khoản Repo', 'Repo product type management', 'select ACTYPE,ACNAME,GLGRP,TPR,A1.CDCONTENT STATUS,A2.CDCONTENT RPCLASS,A3.CDCONTENT RPTYPE,
...
AND A6.CDTYPE = ''RP'' AND A6.CDNAME = ''TRTYPE'' AND TRIM(A6.CDVAL)= TRIM(RPTYPE.TRTYPE)', 'RPTYPE', 'frmRPTYPE', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
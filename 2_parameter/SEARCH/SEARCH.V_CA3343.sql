SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('V_CA3343','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('V_CA3343', 'Danh sách inport điều chỉnh số tiền phân bổ', 'Coporate action list detail', 'SELECT CA.AUTOID, CA.TRADE, CA.CAMASTID, CA.AFACCTNO,A0.CDCONTENT CATYPE, CA.CODEID, CA.EXCODEID,
...
AND AFMAST.CUSTID = CFMAST.CUSTID AND CA.CAMASTID = REPLACE(TB.CAMASTID,''.'','''') AND CA.AFACCTNO = TB.AFACCTNO
 AND nvl(TB.DELTD,''N'') <> ''Y''', 'CAMAST', '', '', '3343', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
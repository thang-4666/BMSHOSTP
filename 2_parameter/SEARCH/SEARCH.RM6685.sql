SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RM6685','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('RM6685', 'Tra cứu danh sách bảng kê chờ gửi offline (6685)', 'View EOD report send manualy (6685)', 'SELECT MST.AUTOID, MST.VERSION,MST.VERSIONLOCAL, MST.TXDATE, MST.REFBANK,MST.REFBANK || '':'' || CRB.BANKNAME BANKNAME
...
AND A1.CDVAL=MST.TRFCODE AND MST.STATUS IN (''A'') AND CRB.STATUS IN (''O'',''D'')', 'CRBTRFLOG', '', '', '6685', 0, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
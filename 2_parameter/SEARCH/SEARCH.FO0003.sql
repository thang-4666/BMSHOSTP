SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('FO0003','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('FO0003', 'So phu tai khoan chung khoan', 'Custody account statement', 'SELECT DISTINCT LG.TXDATE, LG.TXNUM, LG.TXTIME, LG.TLTXCD, LG.TXDESC, SYM.SYMBOL, LG.MSGAMT, LG.MSGACCT, TRF.NAMT TRFVAL
...
WHERE AF.ACCTNO=MST.AFACCTNO AND MST.ACCTNO=TRF.ACCTNO AND TRF.TXDATE=LG.TXDATE AND TRF.TXNUM=LG.TXNUM AND LG.DELTD<>''Y''
AND SYM.CODEID=MST.CODEID AND TX.APPTYPE=''SE'' AND TX.FIELD=''TRADE'' AND TX.TXCD=TRF.TXCD AND AF.ACCTNO=''<$AFACCTNO>''', 'USERLOGIN', '', 'TXDATE, TXNUM', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
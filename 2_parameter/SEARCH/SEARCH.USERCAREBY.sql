SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('USERCAREBY','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('USERCAREBY', 'Quản lý người sử dụng', 'User management', 'SELECT M.TLID, M.TLNAME, M.TLFULLNAME,M.IDCODE, N.BRNAME, M.TLTITLE, M.TLPRN, A1.CDCONTENT TLGROUP, A2.cdcontent ACTIVE, M.DESCRIPTION,

SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('OD8811','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('OD8811', 'Tra cứu giải tỏa lệnh mua chưa send (8811)', 'View release secured buy sending order(wait for 8811)', 'SELECT MST.ORDERID, MST.ACTYPE, MST.CODEID, CCY.SYMBOL, CCY.PARVALUE, MST.AFACCTNO, MST.SEACCTNO, MST.CIACCTNO,
    CF.FULLNAME CUSTNAME, CF.CUSTODYCD, CF.ADDRESS, CF.IDCODE LICENSE, CI.RAMT, CI.AAMT, CI.RAMT-CI.AAMT AVLAMT, CI.BALANCE,
    CI.ODAMT, CI.BAMT, SE.SECURED, MST.TXDATE, MST.TXNUM, MST.EXPDATE, MST.BRATIO, MST.BRATIO/100 SRATIO, MST.CLEARDAY,
    MST.VOUCHER, MST.EXECAMT-MST.EXAMT AVLEXAMT, MST.QUOTEPRICE, MST.STOPPRICE, MST.LIMITPRICE, MST.EXPRICE, MST.EXQTTY,
    MST.EXECAMT, MST.EXAMT, MST.FEEAMT, MST.FEEACR, MST.RLSSECURED, MST.MATCHAMT, MST.SECUREDAMT,
...
WHERE MST.AFACCTNO = AF.ACCTNO And MST.CIACCTNO = CI.ACCTNO AND MST.SEACCTNO = SE.ACCTNO
    ...
    AND A3.cdval =CCY.tradeplace  AND A3.cdtype =''OD'' AND A3.cdname =''TRADEPLACE''', 'ODMAST', '', '', '8811', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
...
group by a.camastid, a.isincode ) where 0=0
', 'CAMAST', '', 'AUTOID DESC', '3340', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
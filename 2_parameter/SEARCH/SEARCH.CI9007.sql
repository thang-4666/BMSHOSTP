SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CI9007','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('CI9007', 'Quản trị nguồn giải ngân ứng trước (1155)', 'Resource Management disbursed advance (1155)', 'SELECT AD.AUTOID, AD.ISMORTAGE, AD.STATUS, AD.DELTD, AD.ACCTNO, AD.TXDATE, AD.TXNUM, AD.REFADNO, AD.CLEARDT,
...
WHERE AD.RRTYPE = A1.CDVAL AND A1.CDNAME =''RRTYPE''
      AND A1.CDTYPE =''LN''', 'CI.CIMAST', '', '', '1155', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', '', 'N', '', '');COMMIT;
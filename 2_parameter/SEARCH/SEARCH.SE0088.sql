SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE0088','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('SE0088', 'Danh sách KH gửi hồ sơ chuyển khoản chứng khoán ra ngoài', 'Danh sách KH gửi hồ sơ chuyển khoản chứng khoán ra ngoài', 'SELECT sendoutid, CUSTODYCD, FULLNAME, IDCODE, IDDATE, IDPLACE, ADDRESS, MOBILESMS,
...
A.CDCONTENT, tl.sendoutid ) WHERE 0=0', 'CFMAST', 'frmCFMAST', '', '', NULL, 50, 'N', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;
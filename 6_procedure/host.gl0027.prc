SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "GL0027" (
...
FROM
    ...
    SELECT  TL.TLTXCD, TL.TXDATE, TL.TXNUM, TL.BUSDATE, GL.CCYCD, TL.TXDESC,CF.fullname ,CF.custid,
                ...
                MI.CUSTID MICUSTID, MI.CUSTNAME MICUSTNAME, MI.TASKCD, MI.DEPTCD, MI.DESCRIPTION
     FROM  TLLOGALL TL, GLTRANA GL,AFMAST AF ,CFMAST CF, GLTRANA GL1, MITRAN MI
   ...
   --  AND MI.deltd <> 'Y'
     UNION ALL
         SELECT  TL.TLTXCD, TL.TXDATE, TL.TXNUM, TL.BUSDATE, GL.CCYCD, TL.TXDESC,CF.fullname ,CF.custid,
                ...
                (CASE WHEN GL.DORC='C' THEN GL.AMT ELSE 0 END) CRAMT, GL1.ACCTNO COACCTNO, GL1.AMT,
                MI.CUSTID MICUSTID, MI.CUSTNAME MICUSTNAME, MI.TASKCD, MI.DEPTCD, MI.DESCRIPTION
     FROM  TLLOG TL, GLTRAN GL,AFMAST AF ,CFMAST CF, GLTRAN GL1, MITRAN MI
     WHERE TL.TXDATE=GL.TXDATE
     AND TL.TXNUM=GL.TXNUM
     AND TL.DELTD<>'Y'
     AND TL.BUSDATE >= TO_DATE (F_DATE, 'DD/MM/YYYY')

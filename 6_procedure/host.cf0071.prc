...
BEGIN
  ...
  -- END IF;
   ...
   -- GET REPORT'S DATA
      ...
      SELECT getcurrdate CURR,CF.FULLNAME,  A2.CDCONTENT VIA ,NVL(BR.BRNAME,'') BRNAME,
             CF.IDPLACE, CF.IDCODE, CF.IDDATE, NVL(CF.RECEIVEADDRESS,CF.ADDRESS) ADDRESS,
       ...
       FROM CFMASTTEMP CF,ALLCODE A1    , ALLCODE A2    , BRGRP BR,TLPROFILES TL,

SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "RM0043"
   (
...
/*
    ...
    CRB.BANKNAME BANKNAME,REQ.AFACCTNO,REQ.BANKACCT DEBANKACOUNT,RF.CUSTNAME_R DEBANKNAME,
    CF.CUSTODYCD SECACCOUNT,RF.DESACCTNO_R BANKACCT,RF.DESACCTNAME_R BANKACCNAME,
    ...
    AND LG.TRFCODE='TRFCAUNREG';  --AND LG.REFBANK LIKE v_BankCode;
EXCEPTION
    WHEN OTHERS THEN
        RETURN ;
END; -- Procedure

SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE od10101 (
...
select custodycd, Buy_qtty/1000 Buy_qtty, TRUNC(buy_amt/1000000,3) buy_amt, Sell_qtty/1000 Sell_qtty,
...
(
    ...
    (
        select od.custodycd custodycd,
            ...
            sum(od.matchprice*od.matchqtty) amt
        ...
        where od.txdate between V_FRDATE and V_TODATE AND substr(OD.custodycd,4,1) <> 'P'
            ...
            and od.CUSTODYCD =cf.custodycd AND cf.custatcom = 'Y'

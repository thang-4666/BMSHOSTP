SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "GL0016" (
...
-- GET REPORT'S DATA
 ...
 SELECT ROUND(BE_BALANCE) BE_BALANCE,  MST.TLTXCD TLTXCD  ,MST.BUSDATE TXDATE,MST.TXNUM TXNUM,MST.TXDESC TXDESC,TO_CHAR(MI.TASKCD_NAME) TASKCD ,TO_CHAR(MI.MICD_NAME) MICD ,TO_CHAR(MI.DEPTCD_NAME) DEPTCD

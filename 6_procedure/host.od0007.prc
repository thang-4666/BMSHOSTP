SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "OD0007" (
...
--DANH SACH LENH THOA THUAN CHUYEN LEN TRUNG TAM HA NOI
      ...
      OPEN pv_refcursor
       FOR
          SELECT issuerid, exectype1, symbol, orderid,  txtime,
                 quoteprice, orderqtty, exectype,custid,afacctno

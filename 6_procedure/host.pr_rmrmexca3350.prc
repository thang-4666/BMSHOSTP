SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE pr_rmRMEXCA3350(p_txdate IN varchar2,p_err_code  OUT varchar2)
  IS
  ...
  BEGIN
    ...
    (
        ...
        FROM
        TLLOGALL LOG,TLLOGFLDALL TLF,TLLOGFLDALL TLF1,AFMAST AF,CFMAST CF,CIMAST CI,CRBDEFACCT CRA,CRBDEFBANK CRB

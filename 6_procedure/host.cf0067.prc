...
SELECT DISTINCT AFTYPE, AFNAME,ACTYPE, TYPENAME ,TYPE, NAME
FROM(
-- MRTYPE
...
WHERE AF.LNTYPE=LN.ACTYPE
UNION ALL
SELECT AF.ACTYPE AFTYPE , AF.TYPENAME AFNAME,LN.ACTYPE,LN.TYPENAME,'LN' TYPE, 'Lãi trong hạn 1: '||to_char(LN.RATE1,'990.9999') NAME
FROM AFTYPE AF, LNTYPE LN
WHERE AF.LNTYPE=LN.ACTYPE
UNION ALL
SELECT AF.ACTYPE AFTYPE , AF.TYPENAME AFNAME,LN.ACTYPE,LN.TYPENAME,'LN' TYPE, 'Lãi trong hạn 2: '||to_char(LN.RATE2,'990.9999') NAME
FROM AFTYPE AF, LNTYPE LN
WHERE AF.LNTYPE=LN.ACTYPE
UNION ALL
SELECT AF.ACTYPE AFTYPE , AF.TYPENAME AFNAME,LN.ACTYPE,LN.TYPENAME,'LN' TYPE, 'Lãi quá hạn: '||to_char(LN.RATE3,'990.9999') NAME
FROM AFTYPE AF, LNTYPE LN
WHERE AF.LNTYPE=LN.ACTYPE
UNION ALL
...
WHERE AFTYPE LIKE V_AFTYPE
ORDER BY AFTYPE, ACTYPE, TYPE, NAME

SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "SP_BD_GETORDERFORCANCEL" (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR, AFACCTNO IN VARCHAR2)
  IS
...
BEGIN
    ...
    WHERE MST.ORSTATUS <> '7' AND CF.ACCTNO=MST.AFACCTNO AND MST.AFACCTNO=V_PARAFILTER
    ...
    WHERE  REFOD.ORSTATUS <> '7' AND MST.DELTD='N' AND CF.ACCTNO=MST.AFACCTNO AND MST.AFACCTNO=V_PARAFILTER
    ...
    AND MST.DELTD='N' AND CF.ACCTNO=MST.AFACCTNO AND SYINFO.SYMBOL=MST.SYMBOL AND MST.AFACCTNO=V_PARAFILTER
        AND CD1.cdtype ='FO' AND CD1.CDNAME='STATUS' AND CD1.CDVAL=MST.status
        AND SYS.SYSNAME='CONTROLCODE'  AND CFMAST.CUSTID=CF.CUSTID
        AND CD2.cdtype ='FO' AND CD2.CDNAME='EXECTYPE' AND CD2.CDVAL=MST.EXECTYPE
        AND CD3.cdtype ='FO' AND CD3.CDNAME='BOOK' AND CD3.CDVAL=MST.BOOK

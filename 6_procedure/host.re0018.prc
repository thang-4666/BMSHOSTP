...
BEGIN
   ...
   END IF;
    ...
    v_todate         := to_date(T_DATE,'dd/mm/rrrr');
     ...
     OPEN PV_REFCURSOR
     FOR
   SELECT TRADINGDATE,TTHOAMT,TTHAAMT,TTUPCOMAMT,VCBSHOAMT,VCBSHAAMT,VCBSUPCOMAMT,FEEACR,
  ...
  FROM(
            ...
            FROM (
                ...
                FROM
                      (SELECT TO_DATE(HI.TRADINGDATE,'DD/MM/RRRR') TRADINGDATE, NVL(TO_NUMBER(HI.totalvalue),0) TOTALVOLUME,

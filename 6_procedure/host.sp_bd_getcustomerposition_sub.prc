SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "SP_BD_GETCUSTOMERPOSITION_SUB" (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,
...
BEGIN
  V_AFACCTNO := AFACCTNO;
  SELECT cf.CUSTODYCD INTO V_PARAFILTER FROM cfmast cf,afmast af

...
END IF;
   ...
   -- GET INFORMATION OF AUTH'STRING
    ...
    (
            ...
            SELECT CF.CUSTODYCD, AF.ACCTNO AFACCTNO, CF.FULLNAME, CF.IDCODE, CF.IDTYPE, CF.CUSTTYPE, CFA.CUSTID, CF2.FULLNAME AUTHFULLNAME,
                ...
                (
                    ...
                    (
                        ...
                        UNION ALL
                        SELECT SUBSTR(MTL.RECORD_KEY,11,10) AFACCTNO, CFA.AUTOID AUTHAUTOID, MTL.MAKER_DT CHANGEDATE, MTL.ACTION_FLAG
               ...
               WHERE CF.CUSTID = AF.CUSTID
                    AND CF.CUSTID = CFA.CUSTID
                    AND CFA.CFCUSTID = CF2.CUSTID
                    AND CF.CUSTID = IC.AFACCTNO
        ...
        LEFT JOIN
        (
            SELECT CFA.cfcustid, CFA.AUTOID AUTHAUTOID,

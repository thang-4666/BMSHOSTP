SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "SE0071" (
...
SELECT CF.FULLNAME SENDER, CF.CUSTODYCD SENDER_CUSTCD, AF.ACCTNO SENDER_ACC , SB2.SYMBOL SYMBOL,
       OU.RECUSTODYCD, OU.RECUSTNAME, OU.outward,(trade /*+  caqtty */+ strade +  /*scaqtty +*/ ctrade /*+  ccaqtty*/)*SB.parvalue GIATRI,
       trade /*+  caqtty*/ + strade /*+  scaqtty*/ + ctrade /*+  ccaqtty*/ MSGAMT, SB.parvalue,
       CASE WHEN SB.refcodeid IS NOT NULL AND TRADE /*+ CAQTTY*/ + STRADE /*+ SCAQTTY*/ + CTRADE /*+ CCAQTTY*/ > 0 THEN '7'--bo chuyen quyen
...
UNION ALL
SELECT CF.FULLNAME SENDER, CF.CUSTODYCD SENDER_CUSTCD, AF.ACCTNO SENDER_ACC , SB2.SYMBOL SYMBOL,
       OU.RECUSTODYCD, OU.RECUSTNAME, OU.outward,(blocked + sblocked + cblocked)*SB.parvalue GIATRI,

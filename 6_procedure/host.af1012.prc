SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "AF1012" (
    ...
    -- GET REPORT'S PARAMETERS
     OPEN PV_REFCURSOR FOR
        SELECT CF.custid, CF.custodycd, AF.acctno, cf.fullname, to_char(cf.dateofbirth,'DD/mm/yyyy') dateofbirth,
            cf.idcode, to_char(cf.iddate,'dd/mm/yyyy') iddate, cf.idplace, cf.address, cf.email, cf.mobilesms phone, cf.fax,
            AF.mrcrlimitmax mrlimit, af.mrirate, af.mrmrate, af.mrlrate, TO_CHAR(AF.opndate,'DD/MM/YYYY') opndate, nvl(cfr.fullname,'') authfullname, '' authlicense,
        ...
        FROM CFMAST CF, AFMAST AF, aftype aft, mrtype mrt, sysvar sys1, sysvar sys2, sysvar sys3, SYSVAR SYS4, SYSVAR SYS5,

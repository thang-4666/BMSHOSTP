SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "SA0001_1" (
...
WHERE AL.CDNAME='GRPTYPE' AND  AL.CDTYPE='SA' AND  AL.CDVAL =TLGR.GRPTYPE AND TLGR.GRPTYPE='2'
...
SELECT AL.CDCONTENT TYPE,V_STRGRPID GRPID1,TL1.GRPID, TL1.GRPNAME, AL2.CDCONTENT ACTIVE, COU.COU DESCRIPTION , AL.CDCONTENT GRPTYPE,A1.CDCONTENT BO_PHAN,
...
FROM TLPROFILES TLPRO ,TLGRPUSERS TLGR ,BRGRP BR, TLGROUPS TL1, ALLCODE AL , ALLCODE A1, ALLCODE AL2,
      ...
      FROM (SELECT DISTINCT TLG.TLID
            ...
            WHERE TL.GRPID=TLG.GRPID AND TLG.GRPID like V_STRGRPID
                  AND TL.GRPTYPE='2') )COU

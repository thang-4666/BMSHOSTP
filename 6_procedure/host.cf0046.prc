...
*/
    ...
    (
        ...
        FROM SENDSETOCLOSE TR, VW_TLLOG_ALL TL, TLPROFILES PR,  (SELECT * FROM CFMAST WHERE FNC_VALIDATE_SCOPE(BRID, CAREBY, TLSCOPE, pv_BRID, TLGOUPS)=0) CF,
            (
                ...
                FROM SEMAST SE, SBSECURITIES SB, ALLCODE AL, (SELECT * FROM  (SELECT * FROM CFMAST WHERE FNC_VALIDATE_SCOPE(BRID, CAREBY, TLSCOPE, pv_BRID, TLGOUPS)=0) WHERE FNC_VALIDATE_SCOPE(BRID, CAREBY, TLSCOPE, pv_BRID, TLGOUPS)=0) CF, SBSECURITIES SB1
    ...
    (
       ...
       FROM VW_TLLOG_ALL TL, SEMAST SE,  (SELECT * FROM CFMAST WHERE FNC_VALIDATE_SCOPE(BRID, CAREBY, TLSCOPE, pv_BRID, TLGOUPS)=0) CF,

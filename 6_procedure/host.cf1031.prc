SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf1031 (
...
-- return;
    ...
    OPEN PV_REFCURSOR FOR
        ...
        (
            ...
            select max(tse.autoid) orderid, tse.custid, tse.afacctno, max(tse.tllog_autoid) autoid,tse.txtype,tse.txcd,
                tse.busdate, case when tse.TLTXCD = '8867' then 'Ban' || trim(to_char(sum(tse.namt),'999,999,999,999,999,999')) || ' ' || max(tse.symbol) || ' ngay' || TO_CHAR(tse.busdate,'DD/MM/RRRR')

...
--        ca.interestrate || '(%)', '016',ca.interestrate|| '(%)', '1/1')) CA_TYLE,
        ...
        AND CA.CATYPE NOT IN ('011','010','014','020','017','021',/*'022','005','006',*/'023') AND AF.ACCTNO LIKE V_STRAFACCTNO
        AND CAS.STATUS ='O' GROUP BY CA.CAMASTID,CA.REPORTDATE )DT, SBSECURITIES SB  , ALLCODE A0 WHERE DT.SYMBOL = SB.SYMBOL AND
...
/*
       ...
       0  REPORT_QTTY,
        0 CUTPBALANCE, 0  QTTY,
         0 CUTAQTTY
        , 0   AMT, 0 CP_LE, 0 RIGHT_QTTY, 0 CK_MUA, ' ' NOTE,PLSENT  PL_SENT,'C. UPCOM' SAN_GD
       FROM DUAL*/
         ;

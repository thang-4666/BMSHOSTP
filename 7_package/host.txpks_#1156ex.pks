SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1156ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1156EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1156ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF cspks_ciproc.fn_DrowdownAdvancedPayment(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
       RETURN errnums.C_BIZ_RULE_INVALID;
    END IF;

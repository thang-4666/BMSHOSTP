SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1138ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1138EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1138ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    if trim(p_txmsg.batchname) = 'DAY' and p_txmsg.txnum not like '99%' then
        ----Auto Gen request

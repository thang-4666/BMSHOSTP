    ...
    ***************************************************************************************************/
    if p_txmsg.deltd <> 'Y' then
        ...
        LOOP
           ...
           VALUES (l_afacctno || REC.optcodeid,p_txmsg.txnum,p_txmsg.txdate,'0045', TRUNC(l_qtty * to_number(l_left_rightoffrate / l_right_rightoffrate) ),'',p_txmsg.txfields ('01').value,'N',SEQ_SETRAN.NEXTVAL,p_txmsg.txfields ('01').value,p_txmsg.tltxcd);

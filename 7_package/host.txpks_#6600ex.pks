SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6600ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6600EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6600ex
IS
   pkgctx   plog.log_ctx;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2679ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2679EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2679ex
IS
   pkgctx   plog.log_ctx;

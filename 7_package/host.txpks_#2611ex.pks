SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2611ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2611EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2611ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    SELECT SENDVSDQTTY INTO v_number FROM DFMAST DF WHERE DF.ACCTNO = p_txmsg.txfields('11').value;

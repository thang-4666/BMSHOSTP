...
BEGIN
    ...
    select VARVALUE into v_prevdate from host.sysvar where VARNAME ='PREVDATE';
    select VARVALUE into v_currdate from host.sysvar where VARNAME ='CURRDATE';
    select VARVALUE into v_nextdate from host.sysvar where VARNAME ='NEXTDATE';

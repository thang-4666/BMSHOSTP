SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1115ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1115EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1115ex
IS
   pkgctx   plog.log_ctx;
   logrow   tlogdebug%ROWTYPE;

   c_idcode           CONSTANT CHAR(2) := '01';
   c_custodycd        CONSTANT CHAR(2) := '11';
   c_custid           CONSTANT CHAR(2) := '08';

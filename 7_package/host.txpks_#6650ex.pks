SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6650ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6650EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6650ex
IS
   pkgctx   plog.log_ctx;

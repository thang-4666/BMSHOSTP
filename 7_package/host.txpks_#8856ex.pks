SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8856ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8856EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8856ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_ramt             CONSTANT CHAR(2) := '10';
   c_aamt             CONSTANT CHAR(2) := '11';

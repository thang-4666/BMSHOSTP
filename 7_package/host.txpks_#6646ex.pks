SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6646ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6646EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6646ex
IS
   pkgctx   plog.log_ctx;

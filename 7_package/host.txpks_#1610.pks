SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1610
/** ----------------------------------------------------------------------------------------------------
 ** Module: TX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1610
IS
   pkgctx   plog.log_ctx;
...
plog.setbeginsection (pkgctx, 'pr_txlog');
   ...
   if v_count=0 then
      INSERT INTO tllog(autoid, txnum, txdate, txtime, brid, tlid,offid, ovrrqs, chid, chkid, tltxcd, ibt, brid2, tlid2, ccyusage,off_line, deltd, brdate, busdate, txdesc, ipaddress,wsname, txstatus, msgsts, ovrsts, batchname, msgamt,msgacct, chktime, offtime, reftxnum)
       ...
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'03',0,p_txmsg.txfields('03').value,'Term deposit number');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
       ...
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'18',0,p_txmsg.txfields('18').value,'Open date');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'12',TO_NUMBER(p_txmsg.txfields('12').value),NULL,'All interest payable');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'13',TO_NUMBER(p_txmsg.txfields('13').value),NULL,'Mortgage');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'09',TO_NUMBER(p_txmsg.txfields('09').value),NULL,'Balance');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
       ...
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'17',TO_NUMBER(p_txmsg.txfields('17').value),NULL,'Origin Amount');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'15',TO_NUMBER(p_txmsg.txfields('15').value),NULL,'Direct amount');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'20',TO_NUMBER(p_txmsg.txfields('20').value),NULL,'not INTDUECD');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'16',TO_NUMBER(p_txmsg.txfields('16').value),NULL,'Renew Term Deposit');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'11',TO_NUMBER(p_txmsg.txfields('11').value),NULL,'Interest');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'21',TO_NUMBER(p_txmsg.txfields('21').value),NULL,'Blocked amount');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'22',TO_NUMBER(p_txmsg.txfields('22').value),NULL,'Mortgage amount');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
          VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'23',TO_NUMBER(p_txmsg.txfields('23').value),NULL,'Mortgage interest');
       plog.debug(pkgctx, 'abt to insert into tllogfld');
       INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
...
BEGIN
   IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
      ...
      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0022',ROUND(p_txmsg.txfields('21').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Giải phong tỏa tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0023',ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút gốc tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0040',ROUND(p_txmsg.txfields('21').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Giải phong tỏa tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0024',ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút gốc tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0026',ROUND(p_txmsg.txfields('11').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Nhận lãi tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0032',ROUND((p_txmsg.txfields('10').value-p_txmsg.txfields('15').value)*p_txmsg.txfields('16').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'' || '' || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0029',ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Rút gốc tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0012',ROUND(p_txmsg.txfields('11').value*p_txmsg.txfields('20').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Nhận lãi tiết kiệm, gửi ngày ' || p_txmsg.txfields ('18').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('17').VALUE || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0011',ROUND(p_txmsg.txfields('22').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả gốc cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');

      INSERT INTO CITRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('05').value,'0011',ROUND(p_txmsg.txfields('23').value,0),NULL,p_txmsg.txfields ('03').value,p_txmsg.deltd,p_txmsg.txfields ('03').value,seq_CITRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả lãi cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0042',ROUND(p_txmsg.txfields('22').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả gốc cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0044',ROUND(p_txmsg.txfields('23').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả lãi cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0047',ROUND(p_txmsg.txfields('22').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả gốc cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');

      INSERT INTO TDTRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE (p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields ('03').value,'0045',ROUND(p_txmsg.txfields('23').value,0),NULL,'',p_txmsg.deltd,'',seq_TDTRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'Trả lãi cầm cố tiết kiệm, gửi ngày ' || p_txmsg.txfields ('17').VALUE || ', số tiền gửi ban đầu ' || p_txmsg.txfields ('16').VALUE || '');



      UPDATE CIMAST
         SET 
           BALANCE = BALANCE - (ROUND(p_txmsg.txfields('22').value,0)) - (ROUND(p_txmsg.txfields('23').value,0)) + (ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0)) + (ROUND(p_txmsg.txfields('11').value*p_txmsg.txfields('20').value,0)), LAST_CHANGE = SYSTIMESTAMP
        WHERE ACCTNO=p_txmsg.txfields('05').value;


      UPDATE TDMAST
         SET 
           ODAMTPAID = ODAMTPAID + (ROUND(p_txmsg.txfields('22').value,0)),
           ODAMT = ODAMT - (ROUND(p_txmsg.txfields('22').value,0)),
           BALANCE = BALANCE + (ROUND(p_txmsg.txfields('21').value,0)) - (ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0)),
           INTPAID = INTPAID + (ROUND(p_txmsg.txfields('11').value,0)),
           ODINTPAID = ODINTPAID + (ROUND(p_txmsg.txfields('23').value,0)),
           ODINTACR = ODINTACR - (ROUND(p_txmsg.txfields('23').value,0)),
           PRINTPAID = PRINTPAID + (ROUND((p_txmsg.txfields('10').value+p_txmsg.txfields('21').value-p_txmsg.txfields('22').value-p_txmsg.txfields('23').value)*p_txmsg.txfields('16').value+p_txmsg.txfields('22').value+p_txmsg.txfields('23').value,0)),
           BLOCKAMT = BLOCKAMT - (ROUND(p_txmsg.txfields('21').value,0)),
           MORTGAGE = MORTGAGE - (ROUND((p_txmsg.txfields('10').value-p_txmsg.txfields('15').value)*p_txmsg.txfields('16').value,0)), LAST_CHANGE = SYSTIMESTAMP
...
-- Run Pre Update
   IF txpks_#1610EX.fn_txPreAppUpdate(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
...
-- Run Auto Update
   ...
   END IF;
-- Run After Update
   IF txpks_#1610EX.fn_txAftAppUpdate(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
       RETURN errnums.C_BIZ_RULE_INVALID;
   END IF;
...
-- Run Pre check
   IF txpks_#1610EX.fn_txPreAppCheck(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
       RETURN errnums.C_BIZ_RULE_INVALID;
   END IF;
-- Run Auto check
   ...
   END IF;
-- Run After check
   IF txpks_#1610EX.fn_txAftAppCheck(p_txmsg,p_err_code) <> systemnums.C_SUCCESS THEN
       RETURN errnums.C_BIZ_RULE_INVALID;
   END IF;
...
BEGIN
   ...
   LOOP
       ...
       IF txpks_#1610.fn_AutoTxProcess (l_txmsg,
                                        p_err_code,
                                        p_err_param

...
IS
   ...
   c_activests        CONSTANT CHAR(2) := '15';
   ...
   c_custtype         CONSTANT CHAR(2) := '45';
   c_ncusttype        CONSTANT CHAR(2) := '46';
...
BEGIN
  ...
  UPDATE cfvsdlog SET DELTD ='Y' where txdate =  TO_DATE(p_txmsg.txfields('04').value, systemnums.C_DATE_FORMAT)  and txnum =p_txmsg.txfields('05').value ;

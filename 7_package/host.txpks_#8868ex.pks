SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8868ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8868EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8868ex
IS
   pkgctx   plog.log_ctx;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8867ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8867EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8867ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_parvalue         CONSTANT CHAR(2) := '10';
   c_trfqtty          CONSTANT CHAR(2) := '11';

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#1146EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1146EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#1146EX
IS
   pkgctx   plog.log_ctx;
   ...
   c_vatrate          CONSTANT CHAR(2) := '21';
   c_vatamt           CONSTANT CHAR(2) := '22';

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1191ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1191EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1191ex
IS
   pkgctx   plog.log_ctx;

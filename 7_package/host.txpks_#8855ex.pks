SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8855ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8855EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8855ex
IS
   pkgctx   plog.log_ctx;

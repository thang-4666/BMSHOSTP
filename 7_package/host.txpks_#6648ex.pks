SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6648ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6648EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6648ex
IS
   pkgctx   plog.log_ctx;

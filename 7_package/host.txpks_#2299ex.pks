SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2299ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2299EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2299ex
IS
   pkgctx   plog.log_ctx;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE cspks_vsd_bk_prevhsx04 AS
...
END cspks_vsd_bk_prevhsx04;
 
/


CREATE OR REPLACE PACKAGE BODY cspks_vsd_bk_prevhsx04 as
    ...
    if l_status in ('N','P') then
        for rec in(
            select ca.*, DECODE(ca.catype, '010','DVCA','011','DVSE','005','MEET/XMET','014','RHTS','017','CONV','020','CONV/OTHR',
                                   '021','BONU','015','INTR','016','PRII/REDM','---'
                                ) vsdcatype

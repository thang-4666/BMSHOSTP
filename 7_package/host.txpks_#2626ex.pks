SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2626ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2626EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2626ex
IS
   pkgctx   plog.log_ctx;

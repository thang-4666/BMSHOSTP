  ...
  -- Ducnv check trang thai thi truong hnx
            ...
            --                             OR sectype = '000')
              ...
              l_txmsg.txfields ('82').VALUE     := 0; --set vale for Limit price
               ...
               l_txmsg.txfields ('83').defname   := 'ISBUYIN';
               l_txmsg.txfields ('83').TYPE      := 'C';
               l_txmsg.txfields ('83').VALUE     := l_build_msg (indx).fld83;
      ...
      LOOP
            ...
            --                             OR sectype = '000')
                           ...
                           EXCEPTION
                              WHEN NO_DATA_FOUND
                              THEN
                              plog.error('day la log l_actype: '||l_actype);
                              RAISE errnums.e_od_odtype_notfound;
                           END;
              ...
              -- l_txmsg.txfields ('10').VALUE     := l_build_msg.fld10; --set vale for Clearing day
               ...
               l_txmsg.txfields ('83').defname   := 'ISBUYIN';
               l_txmsg.txfields ('83').TYPE      := 'C';
               l_txmsg.txfields ('83').VALUE     := l_build_msg.fld83;
            ...
            END;
      END LOOP;
      --Begin KRX HSX04 Send Order To Queue
      check_send_order (p_orderid);
      --End NamTv
      COMMIT;                                -- Commit the last trunk (if any)
      /***************************************************************************************************
      ** END;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8815ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8815EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8815ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_currprice        CONSTANT CHAR(2) := '13';

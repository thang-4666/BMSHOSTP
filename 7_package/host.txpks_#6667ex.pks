SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#6667EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6667EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#6667EX
IS
   pkgctx   plog.log_ctx;

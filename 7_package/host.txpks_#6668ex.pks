SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#6668EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6668EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#6668EX
IS
   pkgctx   plog.log_ctx;

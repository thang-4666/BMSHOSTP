SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6649ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6649EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6649ex
IS
   pkgctx   plog.log_ctx;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6682ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6682EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6682ex
IS
   pkgctx   plog.log_ctx;

SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8882ex
/**----------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY txpks_#8882ex
IS
   pkgctx   plog.log_ctx;
...
IS
    ...
    --TungNT added - truong hop corebank
    v_strCOREBANK varchar2(1);
    v_strALTERNATEACCT varchar2(1);
    --End
BEGIN
    ...
    ***************************************************************************************************/
    ...
    If v_strTIMETYPE = 'G' Then
        ...
        */
               begin
                    SELECT A INTO v_count
                            FROM
                            (
                              SELECT 1 A,EXECTYPE,to_char(EFFDATE,'DD/MM/RRRR') EFFDATE FROM FOMAST
                              WHERE ACCTNO=v_strCancelOrderID  AND DELTD<>'Y' AND STATUS<> 'A'
                              UNION
                              SELECT 0 A,EXECTYPE,'' EFFDATE FROM ODMAST WHERE ORDERID= v_strCancelOrderID
                            ) ;
            ...
            */
                ...
                begin
                    ...
                    (
                      SELECT 1 A FROM FOMAST WHERE ACCTNO= v_strCancelOrderID  AND DELTD='Y' AND STATUS<>'A'
                      UNION
                      SELECT 0 A FROM ODMAST WHERE ORDERID=v_strCancelOrderID
                    );
    ...
    If Not v_blnREVERSAL Then
        ...
        --Kiem tra xem neu lenh huy chua doc ma dang o trang thai block cho doc thi khong cho phep huy
            ...
            begin
                ...
                If v_strCUROODSTATUS = 'B' Then
                    ...
                    --Lenh da boc len GW nhung chua nhan duoc phan hoi tu so
                    p_err_code := errnums.C_OD_ORDER_SENDING;
                    Return v_lngErrCode;
        ...
        If v_strCUROODSTATUS = 'N' Then
            ...
            If v_strTLTXCD= '8882' Then
                ...
                End If;
                --TungNT added - truong hop corebank huy lenh chua khop thi phai lam lenh giai toa
                ...
                IF v_strCOREBANK='Y' THEN
                    ...
                    BEGIN
                        ...
                        cspks_odproc.pr_RM_UnholdCancelOD(v_strCancelOrderID,v_dblORDERQTTY,p_err_code);

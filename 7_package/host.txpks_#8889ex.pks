SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#8889EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8889EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#8889EX
IS
   pkgctx   plog.log_ctx;
   ...
   c_trffee           CONSTANT CHAR(2) := '12';
   c_late             CONSTANT CHAR(2) := '13';

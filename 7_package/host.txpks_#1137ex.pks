SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1137ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1137EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1137ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_bankacctno       CONSTANT CHAR(2) := '96';
